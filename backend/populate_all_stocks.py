...
# Comprehensive stock database covering all major sectors
comprehensive_stock_database = [
    # MEGA-CAP TECHNOLOGY (10 stocks)
    {
        "id": str(uuid.uuid4()),
        "symbol": "AAPL",
        "name": "Apple Inc.",
    ...
    },
    {
        ...
        "timeframe": "6M",
        "analyst": "David Kim",
        "analysis": "Google's search dominance remains intact despite AI competition, with cloud segment showing strong 35% growth. YouTube advertising rebounding strongly. However, regulatory pressure increasing and AI integration costs rising.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Meta's Reality Labs investment is paying off with improved VR adoption and AI integration across Facebook and Instagram driving ad revenue growth. The company has significantly improved efficiency with layoffs reducing operating expenses by 20%.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Tesla maintains EV market leadership despite increased competition. Cybertruck production ramping with 2M+ reservations. Energy storage business growing 40% annually. FSD technology advancing with neural net improvements.",
        "key_factors": [
    ...
    },
    {
        ...
        "timeframe": "6M",
        "analyst": "Ashley Wong",
        "analysis": "Netflix benefits from password sharing crackdown driving subscriber growth and ad-tier adoption accelerating. Content slate remains strong with international expansion continuing. Competition stabilizing with Disney+ growth slowing.",
        "key_factors": [
            "Password sharing measures adding 6M subscribers",
            "Ad-tier subscribers growing 70% quarterly",
            "International subscriber growth at 15% YoY",
            "Content costs stabilizing at $15B annually",
            "Free cash flow generation improving",
            "Technical momentum above $480 resistance"
        ],
        ...
        "technical_indicators": {
            "rsi": 67.3,
            "moving_avg_50": 475.20,
            "moving_avg_200": 445.80,
            "pe_ratio": 34.7,
            "volatility": 0.41
        }
    },
    {
        ...
        "confidence_score": 83,
        "timeframe": "9M",
        "analyst": "Dr. Kevin Liu",
        "analysis": "AMD benefits from datacenter AI chip demand with MI300 series competing with NVIDIA. PC market recovery supporting CPU sales. EPYC server processors gaining market share from Intel. Competitive positioning improving significantly.",
        "key_factors": [
            "MI300 AI chips showing strong enterprise adoption",
            "EPYC server market share growing to 24%",
            "PC market recovery supporting Ryzen sales",
            "Data center revenue up 80% YoY",
            "Competition with Intel showing AMD advantages",
            "Technical base formation completing near $150"
        ],
        "last_updated": datetime.utcnow() - timedelta(hours=4),
        "price_change_24h": 4.15,
        "price_change_percent": 2.74,
        "market_cap": "$251.8B",
        "sector": "Technology",
        "technical_indicators": {
            "rsi": 63.8,
            "moving_avg_50": 148.90,
            "moving_avg_200": 135.60,
            "pe_ratio": 42.1,
            "volatility": 0.47
        }
    },
    {
        ...
        "analysis": "Salesforce benefits from digital transformation acceleration and AI integration with Einstein platform. Subscription revenue model provides stability with 90%+ renewal rates. Recent acquisitions strengthening data analytics capabilities.",
        "key_factors": [
    ...
    # FINANCIAL SERVICES (15 stocks)
    {
        ...
        "analysis": "JPMorgan benefits from rising interest rates with net interest income expanding 22% YoY. Credit quality remains strong with charge-offs below historical averages. Investment banking recovering slowly but trading revenues robust.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Bank of America leveraged to rising interest rates with significant deposit base sensitivity. Credit quality metrics improving with charge-off rates declining. Consumer banking franchise strong with digital adoption accelerating.",
        "key_factors": [
    ...
    },
    {
        ...
        "confidence_score": 71,
        "timeframe": "9M",
        "analyst": "Mark Peterson",
        "analysis": "Wells Fargo benefits from higher rates with significant deposit repricing potential. Credit losses normalizing from ultra-low levels. Regulatory caps limiting growth but efficiency improvements driving profitability.",
        "key_factors": [
            "Net interest income benefiting from rate sensitivity",
            "Credit normalization proceeding as expected",
            "Efficiency improvements reducing expenses by 3%",
            "Consumer lending showing resilience",
            "Regulatory environment gradually improving",
            "Book value discount attractive at 1.1x"
        ],
    ...
    },
    {
        ...
        "asset_type": "stock",
        "current_price": 385.70,
        "target_price": 420.00,
        "recommendation": "BUY",
        "risk_level": "MEDIUM",
        "confidence_score": 76,
        "timeframe": "6M",
        "analyst": "Sarah Mitchell, CFA",
        "analysis": "Goldman Sachs benefits from fixed income trading strength and investment banking recovery. Asset management flows improving with alternative investments in demand. Consumer banking retreat allows focus on core strengths.",
        "key_factors": [
            "Fixed income trading revenue up 18% YoY",
            "Investment banking fees showing signs of recovery",
            "Asset management attracting institutional flows",
            "Alternative investments generating strong returns",
            "Consumer banking de-emphasis improving focus",
            "Return on equity target of 15% achievable"
        ],
        "last_updated": datetime.utcnow() - timedelta(hours=5),
        ...
        "technical_indicators": {
            "rsi": 64.2,
            "moving_avg_50": 375.40,
            "moving_avg_200": 345.80,
            "pe_ratio": 14.3,
            "volatility": 0.29
        }
    },
    {
        ...
        "analysis": "Visa benefits from secular shift to digital payments with network effects creating sustainable moat. Cross-border volume recovering to pre-pandemic levels. New payment technologies like contactless and digital wallets driving growth.",
        "key_factors": [
    ...
    # HEALTHCARE (10 stocks)
    {
        ...
        "analysis": "UnitedHealth demonstrates consistent execution across insurance and Optum segments. Medical cost ratios improving with better utilization management. Optum revenue growing 24% annually with margin expansion.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Johnson & Johnson's pharmaceutical segment driving growth with innovative oncology and immunology drugs. Consumer products facing competitive pressure but medical devices recovering post-pandemic. Talc litigation overhang remains.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Pfizer navigating COVID revenue decline while investing heavily in oncology pipeline. RSV vaccine showing strong uptake. Recent acquisitions expanding capabilities in rare diseases and immunology. Valuation attractive post-decline.",
        "key_factors": [
            "Oncology pipeline showing promising Phase 3 results",
            "RSV vaccine Abrysvo gaining market traction",
            "COVID revenue declining but stabilizing",
            "Seagen acquisition enhancing cancer capabilities",
            "Dividend yield attractive at 6.1%",
            "Valuation compelling at 10x forward earnings"
        ],
    ...
    # CONSUMER GOODS (10 stocks)
    {
        ...
        "analysis": "Coca-Cola demonstrates resilient demand with pricing power offsetting volume pressures. International markets driving growth while North America faces headwinds. Portfolio diversification beyond soda continues with health-conscious options.",
        "key_factors": [
            "Organic revenue growth of 6% globally",
            "Pricing actions offsetting inflation pressures",
            "International markets growing 8% YoY",
            "Zero sugar variants gaining market share",
            "Dividend aristocrat with 61-year streak",
    ...
    },
    {
        ...
        "timeframe": "6M",
        "analyst": "Thomas Chen",
        "analysis": "Walmart benefits from consumer trade-down trends and strong e-commerce growth. Same-store sales consistently outperforming with market share gains. International operations improving with focus on profitable markets.",
        "key_factors": [
            "US comp sales growing 4.2% YoY",
            "E-commerce sales up 23% annually",
            "Market share gains in grocery segment",
            "Operating leverage driving margin expansion",
            "International portfolio optimization ongoing",
            "Dividend increases for 51 consecutive years"
        ],
        "last_updated": datetime.utcnow() - timedelta(hours=5),
        "price_change_24h": 2.35,
        "price_change_percent": 1.50,
        "market_cap": "$513.8B",
        "sector": "Consumer Staples",
        "technical_indicators": {
            "rsi": 63.7,
    ...
    # ENERGY (5 stocks)
    {
        ...
        "analysis": "Exxon Mobil benefits from Permian Basin production growth and integrated refining operations. Guyana oil development providing long-term growth catalyst. However, oil price volatility and energy transition concerns limit upside.",
        "key_factors": [
            "Permian production growing 20% annually",
            "Guyana project adding 400k barrels daily",
            "Refining margins remaining elevated",
            "Capital discipline maintaining strong cash flow",
            "Dividend yield attractive at 5.2%",
        ...
        "technical_indicators": {
            "rsi": 48.6,
            "moving_avg_50": 117.40,
            "moving_avg_200": 112.85,
            "pe_ratio": 14.2,
            "volatility": 0.31
        }
    },
    ...
    # INDICES (3 total)
    {
        ...
        "analysis": "S&P 500 shows resilience with strong corporate earnings and economic fundamentals. Technology sector leadership and defensive sector stability provide balanced exposure. Fed policy normalization creating favorable environment.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Oil prices face pressure from increased US shale production and global economic slowdown concerns. SPR releases continuing despite OPEC+ production cuts. Technical indicators showing bearish momentum.",
        "key_factors": [
    ...
    },
    {
        ...
        "analysis": "Bitcoin showing institutional adoption momentum with spot ETF approvals driving $12B inflows. Corporate treasury allocation trend accelerating. Halving event reducing supply inflation to 0.85% annually.",
        "key_factors": [
...
async def populate_comprehensive_stock_database():
    """Populate database with comprehensive stock coverage"""
    try:
        # Clear existing recommendations
        await db.investment_recommendations.delete_many({})
        print("Cleared existing investment recommendations")
        
        # Add more popular stocks across all sectors
        additional_stocks = [
            # More Technology
            {
                "id": str(uuid.uuid4()),
                ...
                "confidence_score": 67,
                "timeframe": "12M",
                "analyst": "Tech Analyst Team",
                "analysis": "Intel is making progress with foundry strategy and new chip architectures. Recent partnerships with automotive and data center clients showing promise. Trading at attractive valuation following recent declines.",
                "key_factors": [
                    "Foundry business gaining external customers",
                    "Data center recovery in 2024 expected",
                    "Automotive chip partnerships expanding",
                    "Government support for domestic manufacturing",
                    "Valuation attractive at 12x forward earnings",
                    "Dividend yield of 1.8% provides income"
                ],
                "last_updated": datetime.utcnow() - timedelta(hours=5),
                "price_change_24h": 0.85,
                "price_change_percent": 2.01,
            ...
            # Consumer Discretionary
            {
                ...
                "analysis": "Home Depot benefits from continued home improvement spending and professional contractor demand. Market share leadership and operational efficiency driving consistent results.",
                "key_factors": [
                    "Pro contractor sales growing 8% annually",
                    "DIY market showing resilience",
                    "Supply chain efficiency improvements",
                    "Digital platform investments paying off",
                    "Real estate market supporting demand",
                    "Share buyback program ongoing"
                ],
                "last_updated": datetime.utcnow() - timedelta(hours=4),
                "price_change_24h": 3.20,
                "price_change_percent": 0.93,
                "market_cap": "$351.2B",
                "sector": "Consumer Discretionary",
                "technical_indicators": {
                    "rsi": 59.1,
                    "moving_avg_50": 342.60,
                    "moving_avg_200": 325.40,
                    "pe_ratio": 22.8,
                    "volatility": 0.25
                }
            },
            # Communication Services
            {
                ...
                "analysis": "Verizon offers defensive characteristics with reliable dividend yield. 5G network investments continue while wireless competition remains intense. Focus on operational efficiency and debt reduction.",
                "key_factors": [
                    "5G network coverage leadership maintained",
                    "Wireless service revenue stable",
                    "Dividend yield attractive at 6.4%",
                    "Debt reduction efforts ongoing",
                    "Competition pressuring ARPU growth",
                    "Business segment showing resilience"
                ],
                "last_updated": datetime.utcnow() - timedelta(hours=6),
        ...
        # Combine all stocks
        all_stocks = comprehensive_stock_database + additional_stocks
        
        # Insert comprehensive database
        result = await db.investment_recommendations.insert_many(all_stocks)
        print(f"Inserted {len(result.inserted_ids)} comprehensive investment recommendations")
        ...
        sample_symbols = [stock["symbol"] for stock in all_stocks[:20]]
        print(f"\nSample symbols included: {', '.join(sample_symbols)}")
...
if __name__ == "__main__":
    asyncio.run(populate_comprehensive_stock_database())